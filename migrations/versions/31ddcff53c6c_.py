...
def upgrade():
    ...
    sa.Column('quest_recom', sa.Boolean(), nullable=True),
    sa.Column('quest_easy', sa.Boolean(), nullable=True),
    sa.Column('quest_info', sa.Boolean(), nullable=True),
    sa.Column('quest_var', sa.Integer(), nullable=True),
